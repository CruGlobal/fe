  ...
  module ChoiceFieldConcern
    ...
    begin
      included do
        ...
        serialize :rating_before_label_translations, Rails::VERSION::MAJOR < 7 ? Hash : { type: Hash }
        serialize :rating_after_label_translations, Rails::VERSION::MAJOR < 7 ? Hash : { type: Hash }
        serialize :rating_na_label_translations, Rails::VERSION::MAJOR < 7 ? Hash : { type: Hash }
      end
